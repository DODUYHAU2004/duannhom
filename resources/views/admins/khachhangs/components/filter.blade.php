        ...
        <div class="perpage">
            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                <select name="perpage" id="" class="form-control input-sm perpage filter mr10">
                    @for($i = 20; $i <=200; $i+=20) <option value="{{$i}}">{{$i}} khách hàng</option>
                        @endfor
                </select>
            </div>
        </div>
        <div class="action">
            <div class="uk-flex uk-flex-middle">
                <select name="user_catalogue_id" id="" class="form-control mr10">
                    <option value="0">Select Member Group</option>
                ...
                <a href="{{route('khachhang.create')}}"><button class="btn btn-primary"><i
                            class="fa fa-plus mr5"></i>Thêm mới thành
                        viên</button></a>
            </div>
        </div>
    </div>
